...
DATA_PATH=/content/drive/Shareddrives/TAD_For_Rehabilitation/vedatad/data/thumos14/videos/test # path/to/video/folder
METADATA_CSV_FILENAME=../data/thumos14/thumos14_test_metadata.csv # path/to/metadata/csv/file. Use the ones provided in the data folder.
...
LOCAL_CHECKPOINT='/content/drive/Shareddrives/TAD_For_Rehabilitation/TSP/train/output/r2plus1d_18-tsp_on_thumos14-scratch/backbone_lr_0.0001-fc_lr_0.004/epoch_7.pth'
